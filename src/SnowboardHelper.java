...
public class SnowboardHelper {

String resortName=null;

SnowboardHelper(String name){
resortName=name;
}
...
SnowboardHelper wisp = new SnowboardHelper("Wisp");
SnowboardHelper canaanValley = new SnowboardHelper("Canaan Valley");
SnowboardHelper timberline = new SnowboardHelper("Timberline");
SnowboardHelper sevenSprings = new SnowboardHelper("Seven Springs");
SnowboardHelper snowshoe = new SnowboardHelper("Snowshoe");

System.out.println("Hello user, my name is Sean and i'm a bot that's designed to answer quesions you have about nearby ski resorts");
...
System.out.println("\nExamples include: Prices, Conditions, Location, etc at one of the listed resorts");
...
if (questionFromUser.contains("Wisp") || questionFromUser.contains("wisp")) {	
	...
	else if (questionFromUser.contains("lodging") || questionFromUser.contains("hotel")) {
...
System.out.println("\n\n\nHope you have a great time shreddin' on the slopes. If you would like to ask another question, please re-run the code.");
}
}
